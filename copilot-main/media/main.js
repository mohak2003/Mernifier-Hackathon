    ...
    window.addEventListener("message", (event) => {
        ...
        switch (message.type) {
            ...
            case "addResponse":
                ...
                if (existingMessage) {
                    ...
                    list.innerHTML +=
                        ...
                        <h2 class="mb-5 flex">${aiSvg}Mernifier</h2>
            ...
            case "addError":
                ...
                const messageValue = message.value || "An error occurred. If this issue persists please clear your session token with `Mernifier: Reset session` command and/or restart your Visual Studio Code. If you still experience issues, it may be due to outage on https://openai.com services.";
